<template>
    <div class="admin">
        ...
        <div class="actions">
            <div>
                ...
                <div v-if="currentTime">
                    <h3>
                        ...
                        <button class="copyBtn" @click="copyToClipboard('currentTime')">
                            Copy
                        </button>
                    </h3>
                </div>
            ...
            <div>
                <h1>Get Owner</h1>
                <button @click="getOwnerHandler">Get Contract Owner</button>
                <div v-if="owner">
                    <h3>
                        Owner's Address: <span ref="owner">{{ owner }}</span>
                        <button class="copyBtn" @click="copyToClipboard('owner')">
                            Copy
                        </button>
                    </h3>
                </div>
...
h1 {
    ...
    text-shadow: 0 0 5px rgb(208, 45, 208), 0 0 10px rgb(208, 45, 208),
        0 0 15px rgb(208, 45, 208);
}
...
button {
    ...
    text-shadow: 0 0 5px rgb(208, 45, 208), 0 0 10px rgb(255, 255, 255),
